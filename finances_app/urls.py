...
urlpatterns = [
    ...
    path('fluxo_caixa/<int:ano>/<int:mes>',
         views.fluxo_caixa_index_referencia, name='fluxo_caixa'),
    ...
    path('contas_receber/<int:id>',
         views.contas_receber_index_id, name='contas_receber'),
]
